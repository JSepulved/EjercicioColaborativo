/*Ejercicio
vamos a pedir al usuario que ingrese la cantidad alumnos a los cuales les asignará una nota, luego de que ingrese la cantidad de notas de cada alumnos, se va a desplegar un menú.
...
function promedioNotas(arregloNotas) {
  //declaramos una variable acumuladora llamada suma, la cual estará encarga de guardar la suma total de todas las notas en nuestro arreglo
  let suma = 0;
...
//vamos a crear una funcion la cual nos muestre si la nota es aprobatoria o reprobatoria
